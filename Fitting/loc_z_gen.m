clear;clc;
load('mu_vec_SM1.mat')
load('seg_config_RMSE_optimal_SM1.mat')
load('fitting_result_SM_m1_round2.mat')
% config 1 z = -800:800
...
fitting_results(3,:) = mu_vec'/10 - fitting_results(6,:);
save('fitting_result_SM_m1_round2.mat',"fitting_results")